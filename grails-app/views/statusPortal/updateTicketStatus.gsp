...
<body>
	<g:form controller="StatusPortal" action="updateTodaysTicket">
		<table>
			...
			<tr>
				<td><label for="impediments">Issue</label></td>
				<td><input type="text" id="impediments" name="impediments"
					></td>
			</tr>
			<tr>
				<td><label for="status">Status</label></td>
				<td><input type="text" id="status" name="status" value="${ticketInfo.status}"
					></td>
			</tr>
			<tr>
				<td><label for="updateDate">Updated Date</label></td>
				<td><input type="text" id="updateDate" name="creationDate" value="${ticketInfo.creationDate}
