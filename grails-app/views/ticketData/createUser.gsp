				...
				<div class="col-md-10">
					...
					<form>
						<div class="col-lg-5">
								...
								<input type="text" class= "form-control" id="employeeId" ng-model="employee.employeeId" name="employeeId" required="">
							
								<label for="employeeName">Name<span style="color:red">*</span>:</label>
								<input type="text" class= "form-control" id="employeeId" ng-model="employee.employeeName" name="employeeName" required="">
							
							
								<label for="employeeManager">Manager Name<span style="color:red">*</span>:</label>		
								...
								<label for="employeeEmailId"> email Id <span style="color:red">*</span>:</label>
