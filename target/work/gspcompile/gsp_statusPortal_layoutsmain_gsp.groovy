...
class gsp_statusPortal_layoutsmain_gsp extends GroovyPage {
...
expressionOut.print(request.contextPath)
printHtmlPart(7)
invokeTag('layoutBody','g',178,[:],-1)
printHtmlPart(8)
})
invokeTag('captureBody','sitemesh',178,['ng-app':("myApp")],1)
printHtmlPart(9)
}
...
public static final long LAST_MODIFIED = 1493023151769L
